...
function Footer() {
  return (
    ...
    <div  className="d-flex justify-content-between">
      ...
      <div style={{width:'400px',color:'black'}} className="intro">
        <h5><i className ="fa-solid fa-music me-2"></i>E-store</h5>
    ...
    <p style={{textDecoration:'none',color:'black'}} className='text-center mt-5'>Copyright © 2024 React Bootstrap. Built with Docusaurus.</p>
  </div>
)
}
